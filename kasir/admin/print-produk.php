...
echo "<center><h2 style='margin-bottom:3px;'>KELOMPOK 4 MART</h2>
    Laporan Produk yang tersedia di Toko</center><hr/> ";
echo "<table width=100% cellpadding=6>
    ...
    $tampil = mysql_query("SELECT * FROM produk left join supplier on produk.id_supplier=supplier.id_supplier 
								left join kategori_produk on produk.id_kategori=kategori_produk.id_kategori ORDER BY id_produk DESC");
  	$posisi = 0;
    $no = $posisi+1;
    ...
    echo "</table><br/><tr><td><br/><span style='float:right; text-align:center;'> Jakarta, $tgl_sekarang <br/>
										Karyawan<br/></br></br>
								(.............................................)
