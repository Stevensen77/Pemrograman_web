...
switch($_GET['act']){
  ...
  default:
    echo "<div class='post_title'><b>Manajemen Konsumen Yang Order Produk.</b></div><br/>
          ...
          <form target='_BLANK' style='float:right;' method=POST action='print_harian.php'>
                  <br>Laporan Harian :

                  <br>Dari tanggal = <input type='date' name='dari_tgl'>
                  <br>Sampai tanggal = <input type='date' name='sampai_tgl'>
