...
echo "<center><h2 style='margin-bottom:3px;'>KELOMPOK 4 MART</h2>
  ...
  $subtotal2    = $h * $s['jumlah'] ;
    ...
    echo "<tr><td>$s[nama_produk]</td><td>$s[jumlah]</td><td>Rp. $harga</td><td>$s[diskon]%</td><td>Rp. $subtotal</td></tr>";
  }
...
echo "<div class='post_title'><b>Detail Order yang harus di bayar.</b></div>
	  ...
	  <tr><td col><br/><span style='float:right; text-align:center;'> KELOMPOK 4 MART, $tgl_sekarang <br/>
	  <br/><br/>
									Kasir<br/></br></br>
								(.............................................)
