     ...
     <img src= "menu/rno.jpg" width="250" height="68" alt="" class="img-circle gambar"/>
	  ...
	  <div class="row" style="">
				...
				<table cellpadding="15">
					<tr><td>
					<a href="dash1.php"><button style="" type="button" class="btn"><img src= "menu/d3.JPG" width="400" height="300" alt="" class="img-circle gambar"/></button>
					 						</a></td></tr>					<tr><td>
				...
				<table cellpadding="15">
					<tr><td>
					 <a href="dash2.php"><button style="" type="button" class="btn" ><img src= "menu/d1.JPG" width="400" height="300" alt=""  class="img-circle gambar"/></button>
						</a></td></tr>
					</table>
				</div>
