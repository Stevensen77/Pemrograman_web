			...
			<section class="amazing-works-area">
    				...
    				<form class="form-basic" method="post">
                        ...
                        <div class="form-row justify-content-center">
							...
							<input type="submit" class="primary-btn d-inline-flex align-items-center" name="login"><span class="lnr lnr-arrow-right"></span></input>
														<button type="button" onclick="window.location.href = 'index.php';" class="primary-btn d-inline-flex align-items-center ">Register
