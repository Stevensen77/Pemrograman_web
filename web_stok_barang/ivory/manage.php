					...
					<div class="row justify-content-center height align-items-center">
						<div class="col-lg-8">
							<div class="banner-content text-center">
								...
								<h1 class="text-white">Manage Items</h1>
							</div>
						</div>
					</div>
				</div>
								...
								<table>
									<thead>
										<tr class="table100-head">
											...
											<th class="column6">Product Number</th>
											<th class="column7">Note</th>
											<th class="column8">Length</th>
											<th class="column9">Capacity</th>
											<th class="column10">PIC</th>
											<th class="column11">Gambar</th>
											<th class="column12">Download</th>
										</tr>
									</thead>
									<tbody>
											<tr>
												...
												<tr>
													...
													<td><img style = "width: 100px;length:100px" src="uploads/<?php echo $row["upload"]; ?>"></td>

												<td><?php
													
													echo "<a href='download_pdf.php?nama=".$row["upload"]."'><img style = 'width: 50px;length: 5px' src='img/download.png'/></a> ";
													?></td>
												</tr>
												<?php $no++;  } ?>
