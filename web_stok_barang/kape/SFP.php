	...
	<table width="473" height="169" border="0" cellpadding="0" cellspacing="0" align=center>
						...
						<tr>
							...
							<select name="type" class="form-control">
							  ...
							  <option value="GLC-SX-MM">GLC-SX-MM</option>
							  <option value="GLC-EX-SM1550-40">GLC-EX-SM1550-40</option>
						...
						<tr>
							...
							<select name="capacity" class="form-control">
							  ...
							  <option value="550 meter">550 meter</option>
							  <option value="40 kilometer">40 kilometer</option>
							</select>
