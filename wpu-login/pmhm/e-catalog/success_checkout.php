...
include '../config.php';
	...
	$sql4 = "SELECT * FROM user WHERE email='".$user."'";
	$result3=mysqli_fetch_array($link->query($sql4));
	$email=$result3['email'];

	$sql2 = "INSERT INTO order_pmhm (no_order,user,waktu,nama_produk,jumlah_produk,total_harga,gambar,status_PO,tanggal_pesan)
			VALUES ('".$no_order."','".$email."',NOW(),'".$nama_produk."','".$kuantitas."','".$harga."','".$gambar."','".$status."','".$date_created."')";
			...
			<div class="row" style="margin-right:110px">
				<div class="col">
					...
					<div class="cart_info_columns clearfix">
						...
						<div class="cart_info_col cart_info_col_price">Status PO</div>
			...
			<div class="row cart_items_row">
				<div class="col">
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_price d-flex flex-row align-items-center justify-content-start">
							<div class="cart_item_price" style="margin-right:50px">
							<?php echo '<p style="font-size:25px;color:red;margin-left:-100px">'.$result['status_PO'].'</p>';?>
							</div>
