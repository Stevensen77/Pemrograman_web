...
<!-- ================================================================================================================================================ -->
	  ...
	  <div class="ftco-section bg-light" id="div_link_ecatalog">
			<center><a href="e-catalog/index.php"><img src="images/ecatalog.jpg" style="width:1200px;height:120px;"></a></center>
	 </div>
...
<!-- ================================================================================================================================================ -->
			...
			<div class="row">
				...
				echo '<img src="images/'.$result['nama'].'" width="100%" height="100%"/> ';
				 ?>
...
<!-- ================================================================================================================================================ -->
			...
			<div class="col-md-7 heading-section text-center ftco-animate dua" id="moulding" style="margin-top:100px;margin-left:230px">
...
<!-- ================================================================================================================================================ -->
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt ftco-animate lima " id="sesi_plywood" style="">
			...
			<?php
				...
				?>
				<img src="<?php
				echo 'images/'.$result['nama'].'" width="100%" height="100%"/> ';
				?>
			</a>
...
<!-- ================================================================================================================================================ -->
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt enam" id="sesi_furniture" style="">
			...
			<div class="row" >
    				...
    				<a href="product.php" class="img d-flex justify-content-center align-items-center" >
					<?php
					echo '<img src="images/'.$result['nama'].'" width="300px" height="100%"/> ';
					?>
    				</a>
