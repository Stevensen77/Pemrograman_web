  ...
  <body>
    ...
    <section class="ftco-section ftc-no-pb ftc-no-pt" id="sesi_about_home" style="background-color:#e9e4e9;">
			...
			<div class="row">
				...
				<a id="link_sertifikat" href="certification_lvlk.php" style="color:red">Link to Certification</a>


				<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate" id="wrap-about">
				  <div class="heading-section heading-section-wo-line pt-md-5 pl-md-5 mb-5">
					<div class="ml-md-0">
						<h2 class="mb-4" style="color:black">About Us</h2>
					</div>
				  </div>
				  <div class="pb-md-5">
								<p align="justify">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
    		...
    		<div class="row" style="margin-top:-60px">
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate"> <!--col-lg-4 untuk lebar 25% -->
					...
					<?php
					echo '<img src="images/'.$result['nama'].'" style="width:100%;height:100%"/>';
					?>
    				</a>
