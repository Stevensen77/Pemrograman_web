...
<!--  ---------------------------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <section class="ftco-section"  style="background-color:#e9e4e9">
      ...
      <a href="documentation.php" class="kembali" id="btn_kembali_certification" style="">
...
<!--  ============================================================================================================================================================ -->
      ...
      <div class="folder" id="lvlk">
      <img src="images/sertifikat_lvlk.jpg" style="">
      <p>LVLK</p>
      </div>

      <div class="folder" id="k3">
        <img src="images/sertifikat_lvlk.jpg" style="">
        <p>K3</p>
      </div>

			<div class="pages-stack" id="certificate" style="">
				<a href="#" class="kembali2" id="btn_kembali_certification_2">
        <img class="back_button" src="images/back.png" />
        </a>
