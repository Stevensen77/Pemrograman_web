...
<!--  ---------------------------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <section class="ftco-section"  style="background-color:#e9e4e9">
      ...
      <a href="#" class="kembali" id="btn_kembali_sub_folder" style="display:none">
      <img class="back_button" src="images/back.png" />
      </a>

			<div class="folder" id="folder1"><p >Past Experience</p></div>

			<div align="center" class="pages-stack" id="experience" style="">
				<a href="#" class="kembali"> <img class="back_button" src="images/back.png" /></a>
				 <h3 style="font-size:20px" align="center"><i>experience</i></h3>
				 <img src="images/paramakarya.jpg" class="gambar_experience">
				 <img src="images/sertifikat_lvlk.jpg" class="gambar_experience" >
				 <img src="images/sertifikat_lvlk.jpg" class="gambar_experience" >
				  <img src="images/sertifikat_lvlk.jpg" class="gambar_experience" >
			</div>
...
<!--  ============================================================================================================================================================ -->
      ...
      <input type="checkbox" id="modal" />
        <label for="modal" class="folder" id="manajemen">
        <img src="images/sertifikat_lvlk.jpg" style="">
        <p style="">Sistem Manajemen</p>
        </label>

      <div class="sub_folder" id="lvlk">
      <img src="images/sertifikat_lvlk.jpg" style="">
      <p>LVLK</p>
      </div>

      <div class="sub_folder" id="k3">
        <img src="images/sertifikat_lvlk.jpg" style="">
        <p>K3</p>
      </div>
...
<!--  ============================================================================================================================================================ -->
       ...
       <div class="folder" id="bahan">
       <img src="images/face back.jpg" style="">
       <p>Alat / Penunjang Produksi</p>
       </div>
          ...
          <!--  ============================================================================================================================================================ -->
          			...
          			<div class="folder" id="folder3"><p >Finished Good</p></div>
