...
$pdf->Image('../logo/minimarket.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS POS KELOMPOK 4',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Permata 1A,Tawakal',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.pos_prti_kel4.com email : kelompok4pos@gmail.com',0,'L');
...
$query=mysqli_query($con,"select * from barang_laku where tanggal=" . $tanggal);
...
$q=mysqli_query($con,"select sum(total_harga) as total from barang_laku where tanggal=".$tanggal);
...
$qu=mysqli_query($con,"select sum(laba) as total_laba from barang_laku where tanggal=".$tanggal);
// select sum(total_harga) as total from barang_laku where tanggal='$tanggal'
